...
После появления первой реализации архитектуру разрешено усложнять только если
одновременно выполнены два условия:

1. Выбранное простое решение не выполняет зафиксированный SLA или создаёт подтверждённую проблему.
...
> Обновление 2026-09-07: визуальный сценарий ниже заменён [адаптивными карточками](.memory-bank/runbooks/app_guide_ru.md#киоск-promo-и-qr), по решению оператора.
