...
PAGES: dict[str, tuple[str, str]] = {
    "advertising": ("Реклама", "Плейлисты и настройки показа для экранов каждой площадки."),
    ...
    "venue-media": ("Медиа площадки", "Загруженные фотографии, оригиналы и состояние обработки."),
    ...
    "spas": ("Площадки", "Названия площадок и настройки поиска камерой на выходе."),
    "attempts": ("Анализ Захватов", "Попытки распознавания и результаты — от захвата до показа фотографий."),
...
NAVIGATION = (
    ...
    ("attempts", "Анализ Захватов", "operator developer", "Результаты попыток распознавания."),
