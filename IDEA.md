# Face Moment: централизованный SPA-фотосервис
...
В каждом SPA находится только промо-клиент с камерой и экраном.
...
## 12. Базовая конфигурация сервера
...
14. Промо-экран с reference-камерой и QR.
...
## 16. Что осознанно не входит в MVP
...
## 17. Условия пересмотра архитектуры
...
## 19. Финальная архитектурная формула
