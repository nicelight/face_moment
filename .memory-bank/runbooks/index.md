---
description: Router for the operational runbooks of Face Moment.
status: active
...
- [Local test deployment](local-test-deployment.md): start a local test stack
  or execute the isolated packaged smoke.
- [Display and central restart recovery](display-and-central-restart.md):
