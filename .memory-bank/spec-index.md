...
| runbook | [.memory-bank/runbooks/app_guide_ru.md](runbooks/app_guide_ru.md) | active | Russian operator guide for current application, kiosk, phone and environments. | Explicit operator update |
...
| subject_feature_concerns | .memory-bank/contracts/*, .memory-bank/domains/*, .memory-bank/states/*, .memory-bank/testing/*, or .memory-bank/runbooks/* | /feature-to-tasks | Discover existing canonical specs first; create only missing subject-based concerns and link exact paths from features/tasks. |
